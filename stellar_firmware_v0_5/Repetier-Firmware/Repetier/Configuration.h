...
#define EXT0_STEPS_PER_MM 154.6
...
#define ZHOME_PRE_RAISE_DISTANCE 70
...
#define Z_PROBE_HEIGHT 32.000
#define Z_PROBE_DELAY 0
#define Z_PROBE_START_SCRIPT "M340 P0 S1650\nG4 P1000\nM340 P0 S0"
#define Z_PROBE_FINISHED_SCRIPT "M340 P0 S700\nG4 P1000\nM340 P0 S0"
...
#define BED_MOTOR_1_X 10
#define BED_MOTOR_1_Y 0
#define BED_MOTOR_2_X 190
#define BED_MOTOR_2_Y 0
#define BED_MOTOR_3_X 10
#define BED_MOTOR_3_Y 190
...
#define UI_PRINTER_NAME "Stellar"
#define UI_PRINTER_COMPANY "By Victor V."
...
#define UI_SET_MIN_EXTRUDER_TEMP   30
#define UI_SET_MAX_EXTRUDER_TEMP   290
#define UI_SET_EXTRUDER_FEEDRATE 1
#define UI_SET_EXTRUDER_RETRACT_DISTANCE 1.6
...
========== Start configuration string ==========
{
    ...
    "uiPrinterName": "Stellar",
    "uiPrinterCompany": "By Victor Vieira",
    ...
    "uiMinHeatedBed": 0,
    "uiMaxHeatedBed": 0,
    "uiMinEtxruderTemp": 30,
    "uiMaxExtruderTemp": 290,
    "uiExtruderFeedrate": 1,
    "uiExtruderRetractDistance": 1.6,
    ...
    "retractionLength": 1.6,
    "retractionLongLength": 13,
    "retractionSpeed": 40,
    "retractionZLift": 0.2,
    "retractionUndoExtraLength": 0,
    "retractionUndoExtraLongLength": 0,
    "retractionUndoSpeed": 30,
